...
//            SearchRequest totalRequest = new SearchRequest(EsConstants.ES_RRL_NOTARY_INDEX);
//            MultiSearchRequest request1 = new MultiSearchRequest();
//            request1.add(totalRequest);
//            MultiSearchResponse response1 = client.msearch(request1, RequestOptions.DEFAULT);
